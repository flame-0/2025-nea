            ...
            >
                ...
                <div className="mt-4 border-t border-neutral-800 pt-3 text-center">
                    <p className="mt-1 text-xs text-neutral-600">
                        {new Date().getFullYear()} • comelec 2025 election data
                    </p>
                    <p className="mt-1 text-xs text-neutral-700">
                        made with ❤️ by{" "}
                        <a
                            href="https://www.facebook.com/CPUnion/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-neutral-500 decoration-neutral-700 underline-offset-2 transition-colors hover:text-orange-400 hover:decoration-orange-400"
                        >
                            cpu
                        </a>
                    </p>
